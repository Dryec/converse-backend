...
namespace Protocol {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 56: {
            state_ = (global::Protocol.Proposal.Types.State) input.ReadEnum();
            break;
          }
        }
      }
  ...
  public sealed partial class Account : pb::IMessage<Account> {
    ...
    public void MergeFrom(Account other) {
      ...
      if (other.accountResource_ != null) {
        if (accountResource_ == null) {
          accountResource_ = new global::Protocol.Account.Types.AccountResource();
        }
      ...
      public sealed partial class AccountResource : pb::IMessage<AccountResource> {
        ...
        public void MergeFrom(AccountResource other) {
          ...
          if (other.frozenBalanceForEnergy_ != null) {
            if (frozenBalanceForEnergy_ == null) {
              frozenBalanceForEnergy_ = new global::Protocol.Account.Types.Frozen();
            }
          ...
          while ((tag = input.ReadTag()) != 0) {
            switch(tag) {
              ...
              case 18: {
                ...
                input.ReadMessage(frozenBalanceForEnergy_);
                break;
              }
              case 24: {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 56: {
            result_ = (global::Protocol.Transaction.Types.Result.Types.contractResult) input.ReadEnum();
            break;
          }
        }
      }
  ...
  public sealed partial class TransactionInfo : pb::IMessage<TransactionInfo> {
    ...
    public void MergeFrom(TransactionInfo other) {
      ...
      if (other.receipt_ != null) {
        if (receipt_ == null) {
          receipt_ = new global::Protocol.ResourceReceipt();
        }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 72: {
            result_ = (global::Protocol.TransactionInfo.Types.code) input.ReadEnum();
            break;
          }
          case 82: {
  ...
  public sealed partial class HelloMessage : pb::IMessage<HelloMessage> {
    ...
    public void MergeFrom(HelloMessage other) {
      ...
      if (other.genesisBlockId_ != null) {
        if (genesisBlockId_ == null) {
          genesisBlockId_ = new global::Protocol.HelloMessage.Types.BlockId();
        }
        GenesisBlockId.MergeFrom(other.GenesisBlockId);
      }
      if (other.solidBlockId_ != null) {
        if (solidBlockId_ == null) {
          solidBlockId_ = new global::Protocol.HelloMessage.Types.BlockId();
        }
        SolidBlockId.MergeFrom(other.SolidBlockId);
      }
      if (other.headBlockId_ != null) {
        if (headBlockId_ == null) {
          headBlockId_ = new global::Protocol.HelloMessage.Types.BlockId();
        }
  ...
  public sealed partial class SmartContract : pb::IMessage<SmartContract> {
    ...
    public void MergeFrom(SmartContract other) {
      ...
      if (other.abi_ != null) {
        if (abi_ == null) {
          abi_ = new global::Protocol.SmartContract.Types.ABI();
        }
            ...
            public void MergeFrom(pb::CodedInputStream input) {
              ...
              while ((tag = input.ReadTag()) != 0) {
                switch(tag) {
                  ...
                  case 48: {
                    type_ = (global::Protocol.SmartContract.Types.ABI.Types.Entry.Types.EntryType) input.ReadEnum();
                    break;
                  }
                  case 56: {
                  ...
                  case 64: {
                    stateMutability_ = (global::Protocol.SmartContract.Types.ABI.Types.Entry.Types.StateMutabilityType) input.ReadEnum();
                    break;
                  }
                }
              }
